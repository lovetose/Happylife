...
public class HardWorld extends World
{
    ...
    public int time;
    GreenfootSound backgroundMusic = new GreenfootSound("Stardew Valley OST - The Library and Museum.mp3");
    int n;
    /**
    ...
    {    
        ...
        super(900, 650, 1);
         ...
         addObject(new ButterFly(), getWidth()/2, getHeight()/2);
    ...
    public void spawn()  
    {  
        if (getObjects(ButterFly.class).isEmpty()) {
        
        }else{
        if (Greenfoot.getRandomNumber(35)<1){
           addObject(new Snake(), Greenfoot.getRandomNumber(900), 0);
           addObject(new Snake(), 0, Greenfoot.getRandomNumber(650));
           addObject(new Snake(), Greenfoot.getRandomNumber(900), 0);
        }
        ...
        if(killCounter.value >= 500){
             if (Greenfoot.getRandomNumber(40)<1){
             addObject(new Snake(), 900,  Greenfoot.getRandomNumber(650));     
            }
        }  
   }
}
